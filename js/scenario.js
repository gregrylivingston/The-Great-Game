...
var scenarios = [
                {
                    ...
                    //other influencers
                          ...
                          {owned:"Syria",by:"Turkey",amount:-50,score:[1,0,1,1,0],},
                          {owned:"Iraq",by:"Turkey",amount:-50,score:[1,1,1,1,0],},
                          {owned:"Lebanon",by:"Turkey",amount:-50,score:[1,0,1,0,0],},
                          {owned:"Israel",by:"Turkey",amount:-50,score:[1,0,0,0,0],},
                          {owned:"Palestine",by:"Turkey",amount:-50,score:[0,0,0,0,0],},
                          ...
                          {owned:"South Korea",by:"Japan",amount:-80,score:[2,0,1,0,1]},
                          {owned:"North Korea",by:"Japan",amount:-50,score:[1,1,1,0,0]},
                          {owned:"Taiwan",by:"Japan",amount:-60,score:[1,0,0,0,1]},
                          {owned:"Hungary",by:"Austria",amount:-86,score:[1,1,1,2,0]},
                          {owned:"Slovakia",by:"Austria",amount:-57,score:[1,0,1,0,0]},
                          {owned:"Croatia",by:"Austria",amount:-58,score:[1,1,1,1,2]},
                          {owned:"Czech Republic",by:"Austria",amount:-72,score:[2,1,2,1,0]},
                    ...
                    //great powers
                          ...
                          {owned:"Cameroon",by:"Germany",amount:-55,score:[1,0,0,0,1]},
                          {owned:"Namibia",by:"Germany",amount:-55,score:[1,0,0,0,0]},
                          {owned:"United Republic of Tanzania",by:"Germany",amount:-55,score:[0,0,0,1,1]},
                          {owned:"Papua New Guinea",by:"Germany",amount:-55,score:[1,0,0,0,1]},
                          {owned:"Togo",by:"Germany",amount:-55,score:[0,0,0,0,0]},
                          {owned:"Rwanda",by:"Germany",amount:-45,score:[0,0,0,0,0]},
                          {owned:"Burundi",by:"Germany",amount:-55,score:[0,0,0,0,0]},

                          {owned:"Belarus",by:"Russia",amount:-86,score:[1,0,0,1,0]},
                          {owned:"Ukraine",by:"Russia",amount:-72,score:[2,1,1,1,1]},
                          {owned:"Lithuania",by:"Russia",amount:-55,score:[1,0,0,0,1]},
                          ...
                          {owned:"Kyrgyzstan",by:"Russia",amount:-62,score:[0,0,0,0,0],},
                          {owned:"Tajikistan",by:"Russia",amount:-61,score:[0,0,0,0,0],},
                          {owned:"Finland",by:"Russia",amount:-55,score:[1,1,1,2,0],},
                          {owned:"Moldova",by:"Russia",amount:-55,score:[0,0,0,0,0],},
                          {owned:"Republic of Serbia",by:"Russia",amount:-25,score:[1,0,0,2,0]},

                          {owned:"Canada",by:"United Kingdom",amount:-88,score:[1,1,1,1,1]},
                          {owned:"Australia",by:"United Kingdom",amount:-92,score:[1,1,0,1,1]},
                          {owned:"India",by:"United Kingdom",amount:-57,score:[2,1,1,2,1]},
                          ...
                          {owned:"Kenya",by:"United Kingdom",amount:-62,score:[1,0,0,1,0]},
                          ...
                          {owned:"Nigeria",by:"United Kingdom",amount:-71,score:[1,0,1,0,0]},
                          ...
                          {owned:"Sri Lanka",by:"United Kingdom",score:[1,0,0,0,1],amount:-76},
                          ...
                          {owned:"Belize",by:"United Kingdom",amount:-75,score:[0,0,0,0,0]},

                          {owned:"New Caledonia",by:"France",amount:-40,score:[0,0,0,0,0]},
                          {owned:"Republic of Congo",by:"France",amount:-40,score:[1,0,0,0,0]},
                          {owned:"Algeria",by:"France",amount:-60,score:[1,0,1,1,1]},
                          {owned:"Vietnam",by:"France",amount:-55,score:[0,0,1,0,1]},
                          {owned:"Cambodia",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Laos",by:"France",amount:-35,score:[0,0,0,0,0]},
                          {owned:"Mauritania",by:"France",amount:-35,score:[0,0,0,0,0]},
                          {owned:"Ivory Coast",by:"France",amount:-35,score:[0,0,1,0,1]},
                          {owned:"Gabon",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Tunisia",by:"France",amount:-35,score:[0,0,0,0,0]},
                          {owned:"Niger",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Mali",by:"France",amount:-35,score:[0,0,0,0,0]},
                          {owned:"Madagascar",by:"France",amount:-35,score:[1,0,0,0,1]},
                          {owned:"Central African Republic",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Chad",by:"France",amount:-35,score:[0,0,0,0,0]},
                          {owned:"Burkina Faso",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Senegal",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Guinea",by:"France",amount:-35,score:[1,0,0,0,0]},
                          {owned:"Morocco",by:"France",amount:-25,score:[1,1,1,1,1]},
                          {owned:"Romania",by:"France",amount:-5,score:[2,1,2,1,0]},
                          {owned:"Djibouti",by:"France",amount:-60,score:[0,0,1,0,1]},
